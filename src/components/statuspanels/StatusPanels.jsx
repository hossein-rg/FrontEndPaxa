...
import styles from "./StatusPanels.module.scss";
...
function StatusPanels() {
  ...
  const postInbound = () => {
    ...
    const url = `${process.env.API_URL}/loginadmin`;
    const postData = {
      email: port,
      password: key,
    };
  ...
  return (
    <div className={styles.topcontainer}>
      ...
      <div className={styles.wave_group}>
        <input required autoComplete="off" type="text" ref={inputport} name="text" className={styles.input} />
      ...
      <div className={styles.wave_group}>
        <input required autoComplete="off" type="text" ref={inputkey} name="text" className={styles.input} />
        <span className={styles.bar}></span>
        <label className={styles.label}>
          <span className={styles.labelChar} style={{ "--index": 0 }}>
            P
